...
public class Song {
    ...
    /**
     * Creates a new song, with specfied 'songId' and 'filePath'.
     *
     * @note It's a unique Android identifier for a media file anywhere on the system
     * @param id =unique Andriod identifer for a media file anywhere on the system.
     *  @param filePath  - full path for the file on the filesystem
     */
